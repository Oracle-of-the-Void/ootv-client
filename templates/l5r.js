...
updates['l5r'] = function (area) {
  $(area+" .listbody").html(function(index, html) {
    ...
    replace(/:fire:/g,'<img class="inlinesymbolbounded" src="res/onyx/fire.png" />'). // | onyx symbol: 
    replace(/:water:/g,'<img class="inlinesymbolbounded" src="res/onyx/water.png" />'). // | onyx symbol: 
    replace(/:void:/g,'<img class="inlinesymbolbounded" src="res/onyx/void.png" />'). // | onyx symbol: 
    replace(/:jade:/g,'<img class="inlinesymbolbounded" src="res/onyx/jade.png" />'). // | onyx symbol: 
    replace(/:pearl:/g,'<img class="inlinesymbolbounded" src="res/onyx/pearl.png" />'). // | onyx symbol: 
    replace(/:maho:/g,'<img class="inlinesymbolbounded" src="res/onyx/maho.png" />'). // | onyx symbol: 
    replace(/:thunder:/g,'<img class="inlinesymbolbounded" src="res/onyx/thunder.png" />'). // | onyx symbol: 
    replace(/:shadowlands:/g,'<img class="inlinesymbolbounded" src="res/onyx/shadowlands.png" />'). // | onyx symbol: 
    ...
    replace(/:pearl\+:/g,'<img class="inlinesymbolbounded" src="res/onyx/bpearl.png" />'). // | onyx symbol: 
    replace(/:maho\+:/g,'<img class="inlinesymbolbounded" src="res/onyx/bmaho.png" />'). // | onyx symbol: 
    replace(/:thunder\+:/g,'<img class="inlinesymbolbounded" src="res/onyx/bthunder.png" />'). // | onyx symbol: 
    replace(/:shadowlands\+:/g,'<img class="inlinesymbolbounded" src="res/onyx/bshadowlands.png" />'). // | onyx symbol: 

    replace(/:fear:/g,'<img class="inlinesymbolbounded" src="res/onyx/fear.png" />'). // | onyx symbol: 
    replace(/:melee:/g,'<img class="inlinesymbolbounded" src="res/onyx/melee.png" />'). // | onyx symbol: 
    replace(/:ranged:/g,'<img class="inlinesymbolbounded" src="res/onyx/ranged.png" />'). // | onyx symbol: 
    replace(/:favor:/g,'<img class="inlinesymbolbounded" src="res/onyx/favor.png" />'); // | onyx symbol: 
  });
};
